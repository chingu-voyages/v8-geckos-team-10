...
const Stories = () => {
  return (
    <div className='stories_container'>
      <h2 className='stories_title'>Meet our Diamonds</h2>
      <div className='testimonials_container'>
        ...
        <figure class="snip1386"><img src="https://images.unsplash.com/photo-1540322112357-ebf4f8bfa63c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="sample10" class="background" />
          <figcaption>
            <blockquote>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus dignissim est vel feugiat tristique. Nulla dignissim in metus eget efficitur. Nulla laoreet volutpat orci, ac pretium libero interdum vel. Aenean fringilla felis at leo feugiat luctus. Quisque eu tellus cursus, ultrices felis quis, rhoncus sem. Pellentesque in ex vitae ex.</blockquote>
            <h5>- Tim Forever</h5>
        ...
        <figure class="snip1386"><img src="https://images.unsplash.com/photo-1521133573892-e44906baee46?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="sample19" class="background" />
          <figcaption>
            <blockquote>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus dignissim est vel feugiat tristique. Nulla dignissim in metus eget efficitur. Nulla laoreet volutpat orci, ac pretium libero interdum vel. Aenean fringilla felis at leo feugiat luctus. Quisque eu tellus cursus, ultrices felis quis, rhoncus sem. Pellentesque in ex vitae ex.</blockquote>
            <h5>- Jenny Jenkins</h5>
