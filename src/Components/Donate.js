...
const Donate = () => {
  return (
    <div className="donate-page__container">
      ...
      <div className="donate__services-container">
        <h2 className="donate__heading--secondary">Our Services</h2>
        <ul className="donate-page__list donate-page__list--services">
          <li>Legal Aid</li>
          ...
          <li>Food Pantry</li>
          <li>
            Legal Services for Immigration and Worker's Compensation Cases
          </li>
        </ul>
      </div>
      <hr className="hr-line" />
      <div className="donate__impact-container">
        <h2 className="donate__heading--secondary">Measuring Impact</h2>
        <p>
          Program evaluations can be costly, requiring time, money, and
          expertise. But, the benefits of these evaluations are tremendous!
          Through ongoing program assessment we can:
        </p>
